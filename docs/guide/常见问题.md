...
- `device`: 设备名, 自 [v2.6.0](https://github.com/DotRacel/emby-keeper0/releases/tag/v2.6.0) 后保持不变, 自 [v7.0.0](https://github.com/DotRacel/emby-keeper0/releases/tag/v2.6.0) 后转为带缓存生成的形式, 同一站点保持不变.
