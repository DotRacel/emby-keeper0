...
如果有其他您需要自定义的项目, 请通过 [Github Issues](https://github.com/emby-keeper/emby-keeper/issues) 反馈.
...
若您的疑问没有得到解答, 您可以通过 [Github Issues](https://github.com/emby-keeper/emby-keeper/issues) 进行反馈.
...
本维护版本已经移除在线验证码解析服务. 如果目标站点强制要求 Cloudflare 验证, Embykeeper 不会再尝试调用远端服务跳过验证, 对应站点可能无法自动完成签到或保活.
